...
const AgricList = (props) => {
  ...
  const handleNavigateToElectronics = () => {
    props.navigation.navigate(`/shoppage/${props._id}`, { item: props });
    setModalVisible(false);
  };

  const handleProductClick = (product) => {
    navigate(`/shoppage/${product.id}`); // Navigate to the product detail page
  };
  ...
  >
    {props.name}
        ...
        <p className="w-1/6 truncate md:flex md:text-lg md:font-bold md:justify-center">{props.price}</p>
