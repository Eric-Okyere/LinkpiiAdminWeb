...
const AgricPost = ({ item }) => {
  ...
  const handleSubmit = async () => {
    if (!name || !phone || !description || !location || !category) {
      alert("Please fill in all required fields, including Name, Phone, Price, Description, category and Location.");
      return;
    }
  ...
  return (
    <>
      ...
      <h1 className="text-xl font-bold md:ml-96">Post Agric Products</h1>
