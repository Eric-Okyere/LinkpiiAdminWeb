...
const About = () => {
  return (
    <div className='p-4 min-h-screen font-serif pt-24'>
      ...
      <div className='flex-0.7 text-center md:text-left font-serif md:text-2xl'>
        ...
        <div className='md:w-1/2 '>
          <img className='rounded-md h-[50vh] md:w-11/12 md:h-5/6' src={Pic} alt='pic' />
        </div>
      ...
      <div className='flex flex-wrap justify-center'>
        <img src={MyCall} className='w-full h-1/3 sm:w-1/2 md:w-1/3 p-2' alt='call' />
